...
estrategias_retencion = {
    ...
    "Avg_class_frequency_total": "Instrucción: El cliente tiene una frecuencia de asistencia históricamente baja. Ofrécele una sesión de evaluación gratuita con un entrenador para diseñarle una rutina más corta y atractiva que se ajuste mejor a su tiempo disponible.",
